...
public class MergeArrays {
    public static void main(String[] args) {
        ...
        int[] minArray = firstArray.length < secondArray.length ? Arrays.copyOf(firstArray, firstArray.length) : Arrays.copyOf(secondArray, secondArray.length);
        int[] maxArray = firstArray.length > secondArray.length ? Arrays.copyOf(firstArray, firstArray.length) : Arrays.copyOf(secondArray, secondArray.length);
